...
main() {
    ...
    prompt_input "Enter custom SSH port number" "2222" validate_ssh_port "Port must be an integer between 1024 and 65535, excluding standard database ports." target_ssh_port
